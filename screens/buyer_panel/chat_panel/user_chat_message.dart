...
class UserChatMessage extends StatefulWidget {
  ...
  @override
  State<UserChatMessage> createState() => _UserChatMessageState();
}

class _UserChatMessageState extends State<UserChatMessage>
    with SingleTickerProviderStateMixin {
  String loggedInRole = "buyer";
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text("${widget.room!.product.shape.first} Diamond",
                              style: const TextStyle(
                                  fontWeight: FontWeight.w600, fontSize: 16)),
                          const SizedBox(height: 2),
                          Text(
                              "${widget.room!.product.carat}ct,${widget.room!.product.color},${widget.room!.product.clarity}",
                              style: const TextStyle(
