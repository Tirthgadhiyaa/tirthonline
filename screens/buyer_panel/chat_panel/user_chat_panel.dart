...
import 'package:jewellery_diamond/screens/buyer_panel/chat_panel/user_chat_message.dart';
        ...
        return InkWell(
          ...
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                Text(
                    "${product.carat}ct • ${product.clarity} • ${product.color}",
                    style: const TextStyle(
                        fontSize: 12, fontWeight: FontWeight.w500)),
                Text(lastMessage?.content ?? "Not Yet Message",
