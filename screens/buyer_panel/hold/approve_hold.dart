...
class ApprovedHoldView extends StatefulWidget {
  ...
  @override
  State<ApprovedHoldView> createState() => _ApprovedHoldViewState();
}

class _ApprovedHoldViewState extends State<ApprovedHoldView> {
  ...
  void _fetchProducts() {
    context.read<DiamondBloc>().add(FetchHold(status:"approved"));
  }
                    ...
                    if (hasHolds)
                      Row(
                        children: [
                          Checkbox(
                            value: allSelected,
                            onChanged: (value) => _selectAll(state.holdlist.map((e) => e.product).toList()),
...
//
// class ApprovedHoldView extends StatefulWidget {
//   const ApprovedHoldView({super.key});
//
//   @override
//   State<ApprovedHoldView> createState() => _ApprovedHoldViewState();
// }
...
//   void initState() {
//     super.initState();
//     context.read<DiamondBloc>().add(FetchApprovedHold());
//   }
//
//   @override
//   Widget build(BuildContext context) {
...
//             ),
//           );
//         } else if (state is ApprovedHoldlistLoaded) {
//           final approvedList = state.approvedHoldlist;
//
//           if (approvedList.isEmpty) {
//             return Center(
//               child: Text(
//                 'No approved hold items.',
//                 style: theme.textTheme.titleMedium,
//               ),
//             );
//           }
...
//               final diamond = approvedList[index];
//               return Card(
//                 child: ListTile(
//                   leading: Icon(Icons.check_circle_outline,
//                       color: theme.colorScheme.primary),
//                   title: Text(diamond.stockNumber ?? 'No Stock Number'),
//                   subtitle: Text(
//                       'Carat: ${diamond.carat?.toStringAsFixed(2) ?? 'N/A'} | Price: \$${diamond.price ?? 'N/A'}'),
//                 ),
//               );
//             },
//           );
