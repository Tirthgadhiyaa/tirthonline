// lib/screens/user_panel/hold/hold_user.dart
...
import 'package:jewellery_diamond/screens/buyer_panel/hold/pending_hold.dart';
...
import 'approve_hold.dart';

class HoldUser extends StatefulWidget {
  static const String routeName = '/user-hold';

  const HoldUser({super.key});

  @override
  State<HoldUser> createState() => _HoldUserState();
}

class _HoldUserState extends State<HoldUser>
  ...
  // void _fetchProducts() {
  //   context.read<DiamondBloc>().add(FetchHold());
  // }
          ...
          children: [
            ...
            Expanded(
              child: _selectedTabIndex == 0
                ...
                tableAnimation: _tableAnimation,
              )
                  : ApprovedHoldView(animationController: _animationController,
                headerAnimation: _headerAnimation,
                tableAnimation: _tableAnimation,),
            ),
            // // Animated Header
  ...
  //                         Checkbox(
  //                           value: allSelected,
  //                           onChanged: (value) => _selectAll(state.holdlist),
